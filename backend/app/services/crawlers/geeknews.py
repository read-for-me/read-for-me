...
class GeekNewsCrawler(BaseCrawler):
    ...
    def __init__(
        ...
        crawl_original: Optional[bool] = None,
        ...
        logger.debug(f"GeekNewsCrawler initialized: crawl_original={self.crawl_original}")
    ...
    def _parse_content(
        ...
        try:
            ...
            metadata = self._build_metadata(
                ...
                comment_count=len(comments) if self.include_comments else self._get_comment_count(soup),
                topic_id=topic_id,
            )
